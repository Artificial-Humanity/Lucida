...
Not every video model starts from text. Some animate a still and cannot render
from a prompt alone; asking them to is a refusal naming the fix rather than a
silent substitution. The probe says which.
